...
#### Pasa altos
Para la atenuación de ondas atribuibles a movimientos respiratorios periódicos, que regularmente se encuentran entre 0.1 Hz a 0.2 Hz, por ejemplo, si se dan 15 respiraciones por min producen un ciclo de 4 segundos y un componente fundamental de 0,25 Hz, caso que llega a intervenir en la segmentacion de la onda ST. Como las señales ECG presentan un rango de señal util de entre 0.5 Hz a 150 Hz, por ello, se realiza regularmente filtros pasa altos con frecuencia de corte de 0. 25 Hz. La filtración provoca atenuación en respuesta de amplitud, disminución de la amplitud pico a pico de la onda sinusoidal, y cambios de fase, desplazamiento de fase de las ondas que afectarán a uno u otros componentes llegan has 10 veces el valor de corte; el estudio menciona que si bien llega a afectar a la frecuencia de 0.5 Hz esta en mínima y solo interfiere en la amplitud del primer armónico y en el desfase del 5to y 6to armónico hasta aproximadamente 5 Hz [4].

Por otro lado, los filtros de paso alto de 0.05 Hz producen armónicos de desplazamiento de fase de hasta aproximadamente 0.5 Hz, un rango en el que no existen señales bioeléctricas intrínsecas y, por lo tanto, la forma del segmento ST permanece inalterada, el primer armónico se identifico en 0,9 Hz [4].
...
Los artefactos eliminados a baja frecuencia son los movimientos realizados durante las mediciones (bajas frecuencias) y el ruido muscular que es común en las altas frecuencias cuyos valores suelen superar a los 100 Hz [5].
